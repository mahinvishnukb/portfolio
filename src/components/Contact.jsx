    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-8">
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-6 backdrop-blur-sm md:p-10">
            <p className="mb-3 text-xs uppercase tracking-[0.3em] text-yellow-400">
              Reach Me
            </p>
            ...
            <p className="mt-3 text-sm leading-7 text-zinc-400 sm:mt-5 sm:leading-8">
          ...
          <div className="rounded-3xl border border-yellow-400/20 bg-yellow-400/5 p-6 shadow-[0_0_70px_rgba(250,204,21,0.08)] md:p-10">
            <p className="mb-3 text-xs uppercase tracking-[0.3em] text-yellow-400">
              Open To
            </p>
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-300 sm:mt-6 sm:text-base sm:leading-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 md:mt-10 md:gap-4">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-yellow-400/20 bg-black/50 px-4 py-3 text-xs font-bold uppercase tracking-wide text-yellow-300 sm:px-5 sm:py-4 sm:text-sm"
                >
                  {item}
                </div>
              ))}
            ...
            <p className="mt-6 text-sm text-zinc-400 md:mt-10 md:text-base">
