  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <img
        ...
        className="absolute inset-0 h-full w-full translate-x-0 translate-y-[12vh] scale-[1.1] object-cover object-[50%_top] opacity-75 brightness-[0.85] contrast-[1.08] saturate-[1.02] sm:translate-x-[18vw] sm:translate-y-0 sm:scale-[1.08] sm:opacity-85 md:translate-x-[10vw] md:scale-[1.01] md:opacity-100 md:brightness-[1.18] md:contrast-[1.08] md:saturate-[1.06]"
      />
